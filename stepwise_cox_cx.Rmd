...
The figure above is the nomogram generated to estimate the patients 1-, 3- and 5- year with predictors from the final Cox ph model. The nomogram produces similar results where treatment types are no strong predictors in the model.